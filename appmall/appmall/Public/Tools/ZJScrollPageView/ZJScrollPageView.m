...
- (instancetype)initWithFrame:(CGRect)frame segmentStyle:(ZJSegmentStyle *)segmentStyle titles:(NSMutableArray *)titles parentViewController:(UIViewController *)parentViewController delegate:(id<ZJScrollPageViewDelegate>) delegate {
...
/**  给外界重新设置视图内容的标题的方法 */
- (void)reloadWithNewTitles:(NSMutableArray *)newTitles andIndex:(NSInteger)index{
    
    self.titlesArray = nil;
    self.titlesArray = newTitles.copy;
    [self.segmentView reloadTitlesWithNewTitles:self.titlesArray andIndex:index];
