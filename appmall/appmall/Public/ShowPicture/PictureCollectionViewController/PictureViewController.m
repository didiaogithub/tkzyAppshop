...
- (void)viewDidLoad {
    ...
    //创建 UICollectionView
    self.pictureCollectonView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 5, self.view.frame.size.width, 75) collectionViewLayout:layout];
...
-(void)deletedPictures:(NSSet *)set
{
    ...
    if (self.itemsSectionPictureArray.count <4) {
        self.pictureCollectonView.frame = CGRectMake(0, 5, self.view.frame.size.width, 75);
    }else if (self.itemsSectionPictureArray.count <8)
    {
        self.pictureCollectonView.frame = CGRectMake(0, 5, self.view.frame.size.width, 160);
    }else
    {
        self.pictureCollectonView.frame = CGRectMake(0, 5, self.view.frame.size.width, 240);
    }
}
    ...
    [self dismissViewControllerAnimated:YES completion:^{
        ...
        [UIView animateWithDuration:.25 delay:0 options:7 animations:^{
            ...
            if (wself.itemsSectionPictureArray.count <4) {
                wself.pictureCollectonView.frame = CGRectMake(0, 5, wself.view.frame.size.width, 75);
            }else if (wself.itemsSectionPictureArray.count <8)
            {
                wself.pictureCollectonView.frame = CGRectMake(0, 5, wself.view.frame.size.width, 160);
            }else
            {
                wself.pictureCollectonView.frame = CGRectMake(0, 5, wself.view.frame.size.width, 240);
            }
