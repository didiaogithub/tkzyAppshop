...
-(CGFloat)getCellHeightCommdetail{
    ...
    CGFloat labHeight = [self.content boundingRectWithSize:CGSizeMake(KscreenWidth - 80,0) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14]} context:nil].size.height;
    return  imgHeight + labHeight;
}
