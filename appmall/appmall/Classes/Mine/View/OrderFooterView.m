...
//            }];
    ...
    [_left0Button mas_makeConstraints:^(MASConstraintMaker *make) {
...
-(void)left0BtnClick:(UIButton*)btn {
    if (self.delegate && [self.delegate respondsToSelector:@selector(left0ButtonClick:)]) {
        [self.delegate left0ButtonClick:btn];
    }
}
