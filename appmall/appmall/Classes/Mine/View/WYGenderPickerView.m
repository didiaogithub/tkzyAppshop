...
- (UIButton *)cancelButton {
    ...
    if (!_cancelButton) {
        ...
        _cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(20, 12, 44, 35)];
...
- (UIButton *)confirmButton {
    ...
    if (!_confirmButton) {
        ...
        _confirmButton = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth - 44 - 20, 12, 44, 35)];
        ...
        [_confirmButton setTitleColor:[UIColor tt_redMoneyColor] forState:UIControlStateNormal];
...
- (UIPickerView *)pickerView {
    ...
    if (!_pickerView) {
        ...
        // 先设置数据源
        [self.genderArray addObjectsFromArray:@[@"女", @"男", @"保密"]];
